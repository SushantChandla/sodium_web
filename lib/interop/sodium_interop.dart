...
external Uint8List crypto_pwhash(num outlen,Uint8List passwd,Uint8List salt,num opslimit,num memlimit,int alg);
external Uint8List crypto_secretbox_easy(Uint8List m, Uint8List n, Uint8List k);
external Uint8List crypto_secretbox_open_easy(Uint8List c, Uint8List n, Uint8List k);
